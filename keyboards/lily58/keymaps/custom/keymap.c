 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_F13,   KC_F14,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_BSLS, \
                          KC_LALT, KC_LGUI,  SYMBOL, KC_SPC,   KC_ENT,   MOVING,  KC_BSPC, KC_EQL \
),
/* SYMBOL
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 * |      |      |      |      |      |      |-------|    |-------|      |   _  |   +  |   {  |   }  |   |  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | TRNS | TRNS |SYMBOL| / TRNS  /       \ TRNS \  |TENKEY| TRNS | DEL  |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_SYMBOL] = LAYOUT( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
                             _______, _______, _______, _______, _______,  TENKEY, _______, KC_DEL \
),
/* MOVING
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | TRNS | TRNS |TENKEY| / TRNS  /       \ TRNS \  | TRNS | TRNS | DEL  |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
...
[_MOVING] = LAYOUT( \
  ...
  KC_LCTRL, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGUP, KC_PGDN,                    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, KC_RCTL, \
  KC_LSFT,  XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT, \
                              _______, _______, TENKEY,  _______, _______,  _______, _______, _______ \
),
/* TENKEY
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |      |      |      |      |NumLck|                    |      |  n7  |  n8  |  n9  |  *   |  /   |
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | TRNS | TRNS |QWERTY| / TRNS  /       \ TRNS \  |QWERTY| TRNS | TRNS |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
  [_TENKEY] = LAYOUT( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_P0,   KC_PDOT, KC_PCMM, KC_PENT, KC_RSFT, \
                             _______, _______, QWERTY,  _______, _______, QWERTY,  _______, _______ \
  )
};
